...
public class MultiplayerMenu extends Menu {
	...
	private String[] strings = { "Back", "Login" };
	...
	public MultiplayerMenu() {
		...
		stringXs[0] = 160;
		stringXs[1] = Core.getGameWidth() - mediumButtonWidth - 50 + 110;

		stringYs[0] = Core.getGameHeight() - buttonHeight + 5;
		stringYs[1] = Core.getGameHeight() - buttonHeight + 5;
	...
	public void clicked(int x, int y) {
		if (rects[0].contains(x, y)) {
			...
			System.out.println("MULTIPLAYERMENU: LOGIN HAS BEEN CLICKED, NEEDS TO BE DONE");
		}
	}
